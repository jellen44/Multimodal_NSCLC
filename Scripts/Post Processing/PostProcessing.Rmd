...
processed_df <- processed_df %>% filter(Data_Types=="Multimodal (Late)" | Data_Types=="Clinical" | Data_Types=="miRNA"| Data_Types=="mRNA" | Data_Types=="Methylation"| Data_Types=="LNC RNAs")
